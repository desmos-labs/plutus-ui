...
function GrantAmountPopup() {
   ...
   */
  function getTitleAndContent(step: TipsStep): {
    title: string;
    content: JSX.Element;
  } {
    switch (step) {
      ...
      case TipsStep.SUCCESS:
        return {
          ...
          content: (
            <p>
              The authorization has been granted successfully. You can check the
              transaction
              <span> </span>
              <a
                target="_blank"
      ...
      default:
        return {
          ...
          content: (
            <p>
              In order to enable social tips you need to grant DesmosTipBot the
              authorization to send tokens on your behalf. Once the
              authorization is granted, DesmosTipBot will be able to send{" "}
              {denom} using your balance when you want to tip someone on
              centralized social networks. How many {denom} would you like to
      ...
      <div className="text-center">
        ...
        {state.step === TipsStep.INPUT_DATA && (
          <div className="mt-4 flex flex-row">
            <input
              ...
              onChange={handleGrantAmountChanged}
            />
        ...
        <div className="flex flex-row mt-6 space-x-5">
          ...
          {state.step === TipsStep.INPUT_DATA && (
            <button
              type="button"
              className="ml-5 w-full button-yellow rounded-lg"
